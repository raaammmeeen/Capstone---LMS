                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								 $query_announcement = mysqli_query($conn,"select * from message_sent LEFT JOIN teacher ON teacher.teacher_id = message_sent.reciever_id where  sender_id = '$session_id'  order by date_sended DESC");					
